...
export default class Video extends HTML5Video {
  ...
  public play(url: string, startFrom?: number): void;
  public setMimeType(mimeType?: string): void;
  public setMediaOption(mediaOption: MediaOption): void;
  ...
  public static createStartTimeMediaOption(startTime: number): MediaOption;
  public static serializeMediaOption(mediaOption: MediaOption): string;
}
